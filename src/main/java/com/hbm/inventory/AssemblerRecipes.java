...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		// makeRecipe(new ComparableStack(ModItems.centrifuge_tower, 1), new AStack[] { new ComparableStack(ModItems.centrifuge_element, 4), new OreDictStack(STEEL.plate(), 4), new ComparableStack(ModItems.wire, 6, MAT_MINGRADE.id), new OreDictStack(LAPIS.dust(), 2), new OreDictStack(ANY_PLASTIC.ingot(), 2), }, 150);
		...
		//makeRecipe(new ComparableStack(ModItems.cyclotron_tower, 1), new AStack[] { new ComparableStack(ModItems.magnet_circular, 6), new ComparableStack(ModItems.magnet_dee, 3), new OreDictStack(STEEL.plate(), 12), new ComparableStack(ModItems.wire, 8, MAT_ALLOY.id), new ComparableStack(ModItems.plate_polymer, 24), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.drill_titanium, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 2), new OreDictStack(DURA.ingot(), 2), new ComparableStack(ModItems.bolt, 2, MAT_DURA.id), new OreDictStack(TI.plate(), 6), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.telepad, 1), new AStack[] { new OreDictStack(ANY_PLASTIC.ingot(), 12), new OreDictStack(SA326.plate(), 2), new OreDictStack(CMB.plate(), 4), new OreDictStack(STEEL.plate(), 2), new ComparableStack(ModItems.wire, 6, MAT_GOLD.id), new ComparableStack(ModItems.circuit_schrabidium, 1), }, 300);
		...
		makeRecipe(new ComparableStack(ModItems.warhead_nuclear, 1), new AStack[] { new ComparableStack(ModItems.boy_shielding, 1), new ComparableStack(ModItems.boy_target, 1), new ComparableStack(ModItems.boy_bullet, 1), new ComparableStack(ModItems.boy_propellant, 1), new ComparableStack(ModItems.wire, 6, MAT_MINGRADE.id), new OreDictStack(TI.plate(), 20), new OreDictStack(STEEL.plate(), 12), }, 300);
		...
		makeRecipe(new ComparableStack(ModItems.circuit_copper, 1), new AStack[] {new ComparableStack(ModItems.circuit_aluminium, 1), new ComparableStack(ModItems.wire, 4, MAT_COPPER.id), new OreDictStack(NETHERQUARTZ.dust(), 1), new OreDictStack(CU.plate(), 1), },100);
		makeRecipe(new ComparableStack(ModItems.circuit_red_copper, 1), new AStack[] {new ComparableStack(ModItems.circuit_copper, 1), new ComparableStack(ModItems.wire, 4, MAT_MINGRADE.id), new OreDictStack(GOLD.dust(), 1), new ComparableStack(ModItems.plate_polymer, 1), },150);
		...
		makeRecipe(new ComparableStack(ModItems.magnetron, 1), new AStack[] { new OreDictStack(ALLOY.ingot(), 1), new OreDictStack(ALLOY.plate(), 2), new ComparableStack(ModItems.wire, 1, MAT_TUNGSTEN.id), new ComparableStack(ModItems.coil_tungsten, 1), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.upgrade_template, 1), new AStack[] { new OreDictStack(STEEL.plate(), 1), new OreDictStack(IRON.plate(), 4), new OreDictStack(CU.plate(), 2), new ComparableStack(ModItems.wire, 6, MAT_COPPER.id), }, 100);
		makeRecipe(new ComparableStack(ModItems.upgrade_speed_1, 1), new AStack[] { new ComparableStack(ModItems.upgrade_template, 1), new OreDictStack(MINGRADE.dust(), 4), new ComparableStack(Items.REDSTONE, 6), new ComparableStack(ModItems.wire, 4, MAT_MINGRADE.id), }, 200);
		makeRecipe(new ComparableStack(ModItems.upgrade_speed_2, 1), new AStack[] { new ComparableStack(ModItems.upgrade_speed_1, 1), new OreDictStack(MINGRADE.dust(), 2), new ComparableStack(Items.REDSTONE, 4), new ComparableStack(ModItems.circuit_red_copper, 4), new ComparableStack(ModItems.wire, 4, MAT_MINGRADE.id), new OreDictStack(ANY_PLASTIC.ingot(), 2), }, 300);
		...
		makeRecipe(new ComparableStack(ModItems.upgrade_effect_1, 1), new AStack[] { new ComparableStack(ModItems.upgrade_template, 1), new OreDictStack(DURA.dust(), 4), new OreDictStack(STEEL.dust(), 6), new ComparableStack(ModItems.wire, 4, MAT_MINGRADE.id), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.upgrade_power_1, 1), new AStack[] { new ComparableStack(ModItems.upgrade_template, 1), new OreDictStack(LAPIS.dust(), 4), new ComparableStack(Items.GLOWSTONE_DUST, 6), new ComparableStack(ModItems.wire, 4, MAT_MINGRADE.id), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.upgrade_fortune_1, 1), new AStack[] { new ComparableStack(ModItems.upgrade_template, 1), new OreDictStack(DIAMOND.dust(), 4), new OreDictStack(IRON.dust(), 6), new ComparableStack(ModItems.wire, 4, MAT_MINGRADE.id), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.upgrade_afterburn_1, 1), new AStack[] { new ComparableStack(ModItems.upgrade_template, 1), new OreDictStack(ANY_PLASTIC.dust(), 4), new OreDictStack(W.dust(), 6), new ComparableStack(ModItems.wire, 4, MAT_MINGRADE.id), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.redcoil_capacitor, 1), new AStack[] { new OreDictStack(GOLD.plate(), 3), new ComparableStack(ModItems.fuse, 1), new ComparableStack(ModItems.wire, 4, MAT_ALLOY.id), new ComparableStack(ModItems.coil_advanced_alloy, 6), new ComparableStack(Blocks.REDSTONE_BLOCK, 2), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.thermo_element, 1), new AStack[] { new OreDictStack(STEEL.plate(), 1), new OreDictStack(CU.plate(), 2), new ComparableStack(ModItems.wire, 2, MAT_MINGRADE.id), new ComparableStack(ModItems.wire, 2, MAT_ALUMINIUM.id), new OreDictStack(NETHERQUARTZ.dust(), 2), }, 150);
		//makeRecipe(new ComparableStack(ModItems.limiter, 1), new AStack[] {new OreDictStack(STEEL.plate(), 3), new OreDictStack(IRON.plate(), 1), new ComparableStack(ModItems.circuit_copper, 2), new ComparableStack(ModItems.wire, 4, MAT_COPPER.id), },150);
		...
		makeRecipe(new ComparableStack(ModBlocks.seal_frame, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 3), new ComparableStack(ModItems.wire, 4, MAT_ALUMINIUM.id), new ComparableStack(Items.REDSTONE, 2), new ComparableStack(ModBlocks.steel_roof, 5), }, 50);
		...
		//makeRecipe(new ComparableStack(ModBlocks.machine_industrial_generator, 1), new AStack[] {new ComparableStack(ModItems.generator_front, 1), new ComparableStack(ModItems.generator_steel, 3), new ComparableStack(ModItems.rotor_steel, 3), new OreDictStack(STEEL.ingot(), 6), new ComparableStack(ModItems.board_copper, 4), new ComparableStack(ModItems.wire, 8, MAT_GOLD.id), new ComparableStack(ModBlocks.red_wire_coated, 2), new ComparableStack(ModItems.pedestal_steel, 2), new ComparableStack(ModItems.circuit_copper, 4), },500);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_shredder, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 2), new OreDictStack(STEEL.plate(), 4), new ComparableStack(ModItems.motor, 2), new ComparableStack(ModItems.wire, 2, MAT_MINGRADE.id), new ComparableStack(ModBlocks.steel_beam, 2), new ComparableStack(Blocks.IRON_BARS, 2), new ComparableStack(ModBlocks.red_wire_coated, 1), }, 200);
		makeRecipe(new ComparableStack(ModBlocks.machine_well, 1), new AStack[] { new ComparableStack(ModBlocks.steel_scaffold, 20), new ComparableStack(ModBlocks.steel_beam, 8), new ComparableStack(ModItems.tank_steel, 2), new ComparableStack(ModItems.motor, 1), new ComparableStack(ModItems.pipes_steel, 3), new ComparableStack(ModItems.drill_titanium, 1), new ComparableStack(ModItems.wire, 6, MAT_MINGRADE.id), }, 250);
		makeRecipe(new ComparableStack(ModBlocks.machine_pumpjack, 1), new AStack[] { new ComparableStack(ModBlocks.steel_scaffold, 8), new OreDictStack(STEEL.block(), 8), new OreDictStack(ANY_PLASTIC.block(), 2), new ComparableStack(ModItems.pipes_steel, 4), new ComparableStack(ModItems.tank_steel, 4), new OreDictStack(STEEL.ingot(), 24), new OreDictStack(STEEL.plate(), 16), new OreDictStack(AL.plate(), 6), new ComparableStack(ModItems.drill_titanium, 1), new ComparableStack(ModItems.motor, 2), new ComparableStack(ModItems.wire, 8, MAT_MINGRADE.id), }, 400);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_refinery, 1), new AStack[] {new OreDictStack(STEEL.ingot(), 16), new OreDictStack(STEEL.plate(), 20), new OreDictStack(CU.plate(), 16), new ComparableStack(ModItems.hull_big_steel, 6), new ComparableStack(ModItems.pipes_steel, 2), new ComparableStack(ModItems.coil_tungsten, 8), new ComparableStack(ModItems.wire, 8, MAT_MINGRADE.id), new ComparableStack(ModItems.circuit_copper, 2), new ComparableStack(ModItems.circuit_red_copper, 1), new ComparableStack(ModItems.plate_polymer, 8), },350);
		makeRecipe(new ComparableStack(ModBlocks.machine_epress, 1), new AStack[] { new OreDictStack(STEEL.plate(), 8), new OreDictStack(ANY_RUBBER.ingot(), 4), new ComparableStack(ModItems.pipes_steel, 1), new ComparableStack(ModItems.bolt, 4, MAT_TUNGSTEN.id), new ComparableStack(ModItems.coil_copper, 2), new ComparableStack(ModItems.motor, 1), new ComparableStack(ModItems.circuit_copper, 1), new NbtComparableStack(ItemFluidCanister.getFullCanister(ModForgeFluids.LUBRICANT)), }, 160);
		makeRecipe(new ComparableStack(ModBlocks.machine_chemplant, 1), new AStack[] { new OreDictStack(STEEL.ingot(), 8), new OreDictStack(CU.plate(), 6), new ComparableStack(ModItems.hull_small_steel, 2), new ComparableStack(ModItems.tank_steel, 4), new ComparableStack(ModItems.hull_big_steel, 1), new ComparableStack(ModItems.wire, 16, MAT_MINGRADE.id), new ComparableStack(ModItems.wire, 3, MAT_TUNGSTEN.id), new ComparableStack(ModItems.circuit_copper, 4), new ComparableStack(ModItems.circuit_red_copper, 2), new ComparableStack(ModItems.plate_polymer, 8), }, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.fusion_center, 1), new AStack[] { new OreDictStack(W.ingot(), 4), new OreDictStack(STEEL.plate(), 6), new ComparableStack(ModItems.wire, 24, MAT_ALLOY.id), }, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.fusion_heater, 1), new AStack[] { new OreDictStack(W.ingot(), 4), new OreDictStack(STEEL.plate(), 2), new OreDictStack(OreDictManager.getReflector(), 2), new OreDictStack(CU.plate(), 4), new ComparableStack(ModItems.magnetron, 1), new ComparableStack(ModItems.wire, 4, MAT_ALLOY.id), }, 150);
		...
		makeRecipe(new ComparableStack(ModBlocks.watz_core, 1), new AStack[] { new ComparableStack(ModBlocks.block_meteor, 1), new ComparableStack(ModItems.circuit_gold, 5), new ComparableStack(ModItems.circuit_schrabidium, 2), new ComparableStack(ModItems.wire, 12, MAT_MAGTUNG.id), new OreDictStack(KEY_CIRCUIT_BISMUTH, 4), }, 350);
		makeRecipe(new ComparableStack(ModBlocks.fwatz_hatch, 1), new AStack[] { new ComparableStack(ModBlocks.fwatz_scaffold, 4), new ComparableStack(ModItems.circuit_bismuth, 1), new ComparableStack(ModItems.circuit_red_copper, 2), new ComparableStack(ModItems.wire, 16, MAT_MINGRADE.id), new OreDictStack(CMB.plate(), 16), }, 250);
		makeRecipe(new ComparableStack(ModBlocks.fwatz_computer, 1), new AStack[] { new ComparableStack(ModBlocks.block_meteor, 1), new ComparableStack(ModItems.wire, 16, MAT_MAGTUNG.id), new OreDictStack(SBD.dust(), 4), new ComparableStack(ModItems.circuit_schrabidium, 4), }, 300);
		...
		makeRecipe(new ComparableStack(ModBlocks.nuke_gadget, 1), new AStack[] { new ComparableStack(ModItems.sphere_steel, 1), new ComparableStack(ModItems.fins_flat, 2), new ComparableStack(ModItems.pedestal_steel, 1), new ComparableStack(ModItems.circuit_targeting_tier3, 1), new ComparableStack(ModItems.wire, 6, MAT_GOLD.id), new OreDictStack(KEY_GRAY, 6), }, 300);
		makeRecipe(new ComparableStack(ModBlocks.nuke_boy, 1), new AStack[] { new ComparableStack(ModItems.hull_small_steel, 2), new ComparableStack(ModItems.fins_small_steel, 1), new ComparableStack(ModItems.circuit_targeting_tier2, 1), new ComparableStack(ModItems.wire, 6, MAT_ALUMINIUM.id), new OreDictStack(KEY_BLUE, 4), }, 300);
		makeRecipe(new ComparableStack(ModBlocks.nuke_man, 1), new AStack[] { new ComparableStack(ModItems.sphere_steel, 1), new ComparableStack(ModItems.hull_big_steel, 2), new ComparableStack(ModItems.fins_big_steel, 1), new ComparableStack(ModItems.circuit_targeting_tier2, 2), new ComparableStack(ModItems.wire, 6, MAT_COPPER.id), new OreDictStack(KEY_YELLOW, 6), }, 300);
		makeRecipe(new ComparableStack(ModBlocks.nuke_mike, 1), new AStack[] { new ComparableStack(ModItems.sphere_steel, 1), new ComparableStack(ModItems.hull_big_aluminium, 4), new ComparableStack(ModItems.cap_aluminium, 1), new ComparableStack(ModItems.circuit_targeting_tier4, 3), new ComparableStack(ModItems.wire, 18, MAT_GOLD.id), new OreDictStack(KEY_LIGHTGRAY, 12), }, 300);
		makeRecipe(new ComparableStack(ModBlocks.nuke_tsar, 1), new AStack[] { new ComparableStack(ModItems.sphere_steel, 1), new ComparableStack(ModItems.hull_big_titanium, 6), new ComparableStack(ModItems.hull_small_steel, 2), new ComparableStack(ModItems.fins_tri_steel, 1), new ComparableStack(ModItems.circuit_targeting_tier4, 5), new ComparableStack(ModItems.wire, 24, MAT_GOLD.id), new ComparableStack(ModItems.wire, 12, MAT_TUNGSTEN.id), new OreDictStack(KEY_BLACK, 6), }, 600);
		makeRecipe(new ComparableStack(ModBlocks.nuke_prototype, 1), new AStack[] { new ComparableStack(ModItems.dysfunctional_reactor, 1), new ComparableStack(ModItems.hull_small_steel, 2), new OreDictStack(EUPH.ingot(), 3), new ComparableStack(ModItems.circuit_targeting_tier5, 1), new ComparableStack(ModItems.wire, 16, MAT_GOLD.id), }, 500);
		makeRecipe(new ComparableStack(ModBlocks.nuke_fleija, 1), new AStack[] { new ComparableStack(ModItems.hull_small_aluminium, 1), new ComparableStack(ModItems.fins_quad_titanium, 1), new ComparableStack(ModItems.circuit_targeting_tier4, 2), new ComparableStack(ModItems.wire, 8, MAT_GOLD.id), new OreDictStack(KEY_WHITE, 4), }, 400);
		makeRecipe(new ComparableStack(ModBlocks.nuke_solinium, 1), new AStack[] { new ComparableStack(ModItems.hull_small_steel, 2), new ComparableStack(ModItems.fins_quad_titanium, 1), new ComparableStack(ModItems.circuit_targeting_tier4, 3), new ComparableStack(ModItems.wire, 10, MAT_GOLD.id), new ComparableStack(ModItems.pipes_steel, 4), new OreDictStack(KEY_CYAN, 4), }, 400);
		makeRecipe(new ComparableStack(ModBlocks.nuke_n2, 1), new AStack[] { new ComparableStack(ModItems.hull_big_steel, 3), new ComparableStack(ModItems.hull_small_steel, 2), new ComparableStack(ModItems.wire, 12, MAT_COPPER.id), new ComparableStack(ModItems.pipes_steel, 1), new ComparableStack(ModItems.circuit_targeting_tier3, 3), new OreDictStack(KEY_BLACK, 12), }, 300);
		makeRecipe(new ComparableStack(ModBlocks.nuke_fstbmb, 1), new AStack[] { new ComparableStack(ModItems.sphere_steel, 1), new ComparableStack(ModItems.hull_big_titanium, 6), new ComparableStack(ModItems.fins_big_steel, 1), new ComparableStack(ModItems.powder_magic, 8), new ComparableStack(ModItems.wire, 12, MAT_GOLD.id), new ComparableStack(ModItems.circuit_targeting_tier4, 4), new OreDictStack(KEY_GRAY, 6), }, 600);
		makeRecipe(new ComparableStack(ModBlocks.nuke_custom, 1), new AStack[] { new ComparableStack(ModItems.hull_small_steel, 2), new ComparableStack(ModItems.fins_small_steel, 1), new ComparableStack(ModItems.circuit_gold, 1), new ComparableStack(ModItems.wire, 12, MAT_GOLD.id), new OreDictStack(KEY_GRAY, 4), }, 300);
		makeRecipe(new ComparableStack(ModBlocks.float_bomb, 1), new AStack[] { new OreDictStack(TI.plate(), 12), new ComparableStack(ModItems.levitation_unit, 1), new ComparableStack(ModItems.circuit_gold, 4), new ComparableStack(ModItems.wire, 6, MAT_GOLD.id), }, 250);
		makeRecipe(new ComparableStack(ModBlocks.therm_endo, 1), new AStack[] { new OreDictStack(TI.plate(), 12), new ComparableStack(ModItems.thermo_unit_endo, 1), new ComparableStack(ModItems.circuit_gold, 2), new ComparableStack(ModItems.wire, 6, MAT_GOLD.id), }, 250);
		makeRecipe(new ComparableStack(ModBlocks.therm_exo, 1), new AStack[] { new OreDictStack(TI.plate(), 12), new ComparableStack(ModItems.thermo_unit_exo, 1), new ComparableStack(ModItems.circuit_gold, 2), new ComparableStack(ModItems.wire, 6, MAT_GOLD.id), }, 250);
		...
		makeRecipe(new ComparableStack(ModItems.grenade_pulse, 4), new AStack[] { new OreDictStack(STEEL.plate(), 1), new OreDictStack(IRON.plate(), 3), new ComparableStack(ModItems.wire, 6, MAT_MINGRADE.id), new ComparableStack(Items.DIAMOND, 1), }, 300);
		...
		makeRecipe(new ComparableStack(ModItems.grenade_nuclear, 1), new AStack[] { new OreDictStack(IRON.plate(), 1), new OreDictStack(STEEL.plate(), 1), new OreDictStack(PU239.nugget(), 2), new ComparableStack(ModItems.wire, 2, MAT_MINGRADE.id), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.gadget_explosive, 4), new AStack[] {new OreDictStack(AL.plate(), 4), new ComparableStack(ModItems.wire, 8, MAT_GOLD.id), new ComparableStack(ModBlocks.det_cord, 4), new OreDictStack(CU.plate(), 1), new OreDictStack(ANY_HIGHEXPLOSIVE.ingot(), 10), new OreDictStack(ANY_PLASTIC.ingot(), 2)}, 200); //8 HE lenses (polymer inserts since no baratol) w/ bridge-wire detonators, aluminum pushers, & duraluminum shell
		makeRecipe(new ComparableStack(ModItems.gadget_wireing, 1), new AStack[] { new OreDictStack(IRON.plate(), 1), new ComparableStack(ModItems.wire, 12, MAT_GOLD.id), }, 100);
		...
		makeRecipe(new ComparableStack(ModItems.boy_propellant, 1), new AStack[] { new ComparableStack(Blocks.TNT, 3), new OreDictStack(IRON.plate(), 8), new OreDictStack(AL.plate(), 4), new ComparableStack(ModItems.wire, 4, MAT_MINGRADE.id), }, 100);
		makeRecipe(new ComparableStack(ModItems.boy_igniter, 1), new AStack[] {new OreDictStack(ANY_HIGHEXPLOSIVE.ingot(), 1), new OreDictStack(AL.plate(), 6), new OreDictStack(STEEL.plate(), 1), new ComparableStack(ModItems.circuit_red_copper, 1), new ComparableStack(ModItems.wire, 3, MAT_MINGRADE.id), }, 150); //HE for gating purposes
		...
		makeRecipe(new ComparableStack(ModItems.man_igniter, 1), new AStack[] { new OreDictStack(STEEL.plate(), 6), new ComparableStack(ModItems.circuit_red_copper, 1), new ComparableStack(ModItems.wire, 9, MAT_MINGRADE.id), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.fleija_igniter, 1), new AStack[] { new OreDictStack(TI.plate(), 6), new ComparableStack(ModItems.wire, 2, MAT_SCHRABIDIUM.id), new ComparableStack(ModItems.circuit_schrabidium, 1), }, 300);
		...
		makeRecipe(new ComparableStack(ModItems.solinium_igniter, 1), new AStack[] { new OreDictStack(TI.plate(), 4), new ComparableStack(ModItems.wire, 2, MAT_ALLOY.id), new ComparableStack(ModItems.circuit_schrabidium, 1), new ComparableStack(ModItems.coil_gold, 1), }, 400);
		...
		makeRecipe(new ComparableStack(ModItems.solinium_propellant, 1), new AStack[] { new OreDictStack(ANY_HIGHEXPLOSIVE.ingot(), 3), new OreDictStack(OreDictManager.getReflector(), 2), new ComparableStack(ModItems.plate_polymer, 6), new ComparableStack(ModItems.wire, 6, MAT_TUNGSTEN.id), new ComparableStack(ModItems.biomass_compressed, 4), }, 350);
		...
		makeRecipe(new ComparableStack(ModBlocks.ams_limiter, 1), new AStack[] { new ComparableStack(ModItems.component_limiter, 5), new OreDictStack(STEEL.plate(), 64), new OreDictStack(TI.plate(), 64), new OreDictStack(TI.plate(), 64), new ComparableStack(ModItems.plate_dineutronium, 16), new ComparableStack(ModItems.circuit_schrabidium, 6), new ComparableStack(ModItems.pipes_steel, 16), new ComparableStack(ModItems.motor, 12), new ComparableStack(ModItems.coil_advanced_torus, 12), new ComparableStack(ModItems.entanglement_kit, 1), }, 6000);
		makeRecipe(new ComparableStack(ModBlocks.ams_emitter, 1), new AStack[] { new ComparableStack(ModItems.component_emitter, 16), new OreDictStack(STEEL.plate(), 64), new OreDictStack(STEEL.plate(), 64), new OreDictStack(TI.plate(), 64), new OreDictStack(TI.plate(), 64), new OreDictStack(TI.plate(), 64), new ComparableStack(ModItems.plate_dineutronium, 32), new ComparableStack(ModItems.circuit_schrabidium, 12), new ComparableStack(ModItems.coil_advanced_torus, 24), new ComparableStack(ModItems.entanglement_kit, 3), new ComparableStack(ModItems.crystal_horn, 1), new ComparableStack(ModBlocks.fwatz_core, 1), }, 6000);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_cyclotron, 1), new AStack[] { 
				...
				new ComparableStack(ModItems.wire, 96, MAT_ALLOY.id),
				new OreDictStack(STEEL.ingot(), 16),
		...
		makeRecipe(new ComparableStack(ModItems.spawn_worm, 1), new AStack[] {
				new OreDictStack(TI.block(), 64),
				new OreDictStack(TI.block(), 11),
				new ComparableStack(ModItems.motor, 64),
				new ComparableStack(ModItems.motor, 11),
				new ComparableStack(ModBlocks.glass_trinitite, 25),
				new ComparableStack(Items.REDSTONE, 64),
				new ComparableStack(Items.REDSTONE, 11),
				new ComparableStack(ModItems.wire, 64, MAT_GOLD.id),
				new ComparableStack(ModItems.wire, 11, MAT_GOLD.id),
		...
		makeRecipe(new ComparableStack(ModItems.gun_egon, 1), new AStack[] {new ComparableStack(ModItems.mechanism_special, 4), new OreDictStack(STEEL.plate(), 16), new OreDictStack(PB.plate(), 24), new ComparableStack(ModItems.coil_advanced_torus, 32), new ComparableStack(ModItems.circuit_targeting_tier6, 4), new ComparableStack(ModItems.plate_polymer, 8), new ComparableStack(ModBlocks.machine_schrabidium_battery, 2), new ComparableStack(ModBlocks.machine_waste_drum, 1), new ComparableStack(ModItems.wire, 8, MAT_COPPER.id)}, 256);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_condenser_powered, 1), new AStack[] {
				...
				new OreDictStack(ANY_RESISTANTALLOY.plate(), 24 /* TODO: 4 plateWelded when they work */),
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_fel, 1), new AStack[] {
				...
				new ComparableStack(ModItems.wire, 64, MAT_MINGRADE.id),
		...
		makeRecipe(new ComparableStack(ModItems.multitool_hit, 1), new AStack[] {
				...
				new OreDictStack(STEEL.plate(), 4),
				new ComparableStack(ModItems.wire, 12, MAT_GOLD.id),
				new ComparableStack(ModItems.motor, 4),
		...
		if(!GeneralConfig.enable528) {
			...
			makeRecipe(new ComparableStack(ModBlocks.machine_cyclotron, 1), new AStack[] {
					...
					new ComparableStack(ModBlocks.hadron_coil_neodymium, 8),
					new ComparableStack(ModItems.wire, 64, MAT_ALLOY.id),
					new OreDictStack(STEEL.ingot(), 16),
					new OreDictStack(STEEL.plate(), 32),
					new OreDictStack(AL.plate(), 32),
					new OreDictStack(ANY_PLASTIC.ingot(), 24),
			...
			makeRecipe(new ComparableStack(ModBlocks.struct_soyuz_core, 1), new AStack[] {
					...
					new ComparableStack(ModItems.circuit_tantalium, 64),
					new ComparableStack(ModItems.circuit_tantalium, 36),
				}, 200);
		}
		makeRecipe(new ComparableStack(ModItems.missile_inferno, 1), new AStack[] {new ComparableStack(ModItems.warhead_incendiary_large, 1), new ComparableStack(ModItems.fuel_tank_large, 1), new ComparableStack(ModItems.thruster_large, 1), new OreDictStack(TI.plate(), 14), new OreDictStack(STEEL.plate(), 20), new OreDictStack(AL.plate(), 12), new ComparableStack(ModItems.circuit_targeting_tier3, 1), },350);
		...
		makeRecipe(new ComparableStack(ModBlocks.large_vehicle_door, 1), new AStack[]{new OreDictStack(PB.plate(), 24), new OreDictStack(STEEL.plate(), 36), new OreDictStack(ALLOY.plate(), 4), new ComparableStack(ModItems.plate_polymer, 2), new OreDictStack(STEEL.block(), 4), new ComparableStack(ModItems.motor, 4), new ComparableStack(ModItems.bolt, 12, MAT_DURA.id), new OreDictStack(KEY_GREEN, 4)}, 500);
		makeRecipe(new ComparableStack(ModBlocks.water_door, 1), new AStack[]{new OreDictStack(STEEL.plate(), 12), new OreDictStack(ALLOY.plate(), 2), new ComparableStack(ModItems.bolt, 2, MAT_DURA.id), new OreDictStack(KEY_RED, 1)}, 500);
		makeRecipe(new ComparableStack(ModBlocks.qe_containment, 1), new AStack[]{new OreDictStack(PB.plate(), 12), new OreDictStack(STEEL.plate(), 24), new OreDictStack(ALLOY.plate(), 8), new ComparableStack(ModItems.plate_polymer, 8), new OreDictStack(STEEL.block(), 2), new ComparableStack(ModItems.motor, 4), new ComparableStack(ModItems.bolt, 16, MAT_DURA.id), new OreDictStack(KEY_BLACK, 4)}, 500);
		...
		makeRecipe(new ComparableStack(ModBlocks.secure_access_door, 1), new AStack[]{new OreDictStack(PB.plate(), 32), new OreDictStack(STEEL.plate(), 48), new OreDictStack(ALLOY.plate(), 16), new ComparableStack(ModItems.plate_polymer, 2), new OreDictStack(STEEL.block(), 6), new ComparableStack(ModItems.motor, 4), new ComparableStack(ModItems.bolt, 24, MAT_DURA.id), new OreDictStack(KEY_CYAN, 8)}, 1000);
		makeRecipe(new ComparableStack(ModBlocks.sliding_seal_door, 1), new AStack[]{new OreDictStack(STEEL.plate(), 6), new OreDictStack(ALLOY.plate(), 2), new ComparableStack(ModItems.plate_polymer, 1), new ComparableStack(ModItems.motor, 1), new ComparableStack(ModItems.bolt, 1, MAT_DURA.id), new OreDictStack(KEY_LIGHTGRAY, 1)}, 300);
		makeRecipe(new ComparableStack(ModBlocks.sliding_gate_door, 1), new AStack[]{new OreDictStack(PB.plate(), 4), new OreDictStack(STEEL.plate(), 12), new OreDictStack(ALLOY.plate(), 4), new ComparableStack(ModItems.plate_polymer, 2), new OreDictStack(STEEL.block(), 1), new ComparableStack(ModItems.motor, 2), new ComparableStack(ModItems.bolt, 2, MAT_DURA.id), new OreDictStack(KEY_WHITE, 2)}, 500);
		makeRecipe(new ComparableStack(ModBlocks.transition_seal, 1), new AStack[]{new ComparableStack(ModBlocks.cmb_brick_reinforced, 16), new OreDictStack(STEEL.plate(), 64), new OreDictStack(ALLOY.plate(), 40), new OreDictStack(ANY_RUBBER.ingot(), 36), new OreDictStack(STEEL.block(), 24), new ComparableStack(ModItems.motor_desh, 16), new ComparableStack(ModItems.bolt, 12, MAT_DURA.id), new OreDictStack(KEY_YELLOW, 4)}, 5000);
		
		makeRecipe(new ComparableStack(ModBlocks.control_panel_custom, 1), new AStack[]{new ComparableStack(ModItems.circuit_targeting_tier5), new OreDictStack(STEEL.block(), 1), new ComparableStack(ModItems.wire, 24, MAT_COPPER.id), new ComparableStack(ModBlocks.pole_top)}, 100);
